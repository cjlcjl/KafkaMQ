...
public class Producer {
    ...
    public static void main(String[] argv)throws Exception {
        ...
        configProperties.put("partitioner.class", "kafka.util.SimplePartitioner");
        ...
        while(!line.equals("exit")) {
            ...
            ProducerRecord<Integer, String> rec = new ProducerRecord<Integer, String>(topicName,(++i)%3,line);
            producer.send(rec);
