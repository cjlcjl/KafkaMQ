...
import kafka.util.AsyncTaskUtil;
...
public class ConsumerTask {
    ...
    public volatile boolean isCommit = true;
    ...
    public static void main(String[] argv)throws Exception{
        ...
        ConsumerThread consumerRunnable = new ConsumerThread(topicName,groupId,consumerTask);
    ...
    private static class ConsumerThread extends Thread{
        ...
        public ConsumerThread(String topicName, String groupId,ConsumerTask consumerTask){
        ...
        public void run() {
            ...
            try {
                while (true) {
                	...
                	//如果执行完毕拉取的任务才继续拉取
                	if(consumerTask.isCommit) {
                		
                		ConsumerRecords<Integer, String> records = kafkaConsumer.poll(100);
                        
                		if(records != null && !records.isEmpty()) {
                			AsyncTaskUtil.asyncTask(consumerTask,records);
                		}
                	}
                	//通过commitSync和kafka保持链接
                	kafkaConsumer.commitSync(); 
                }
